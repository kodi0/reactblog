...
Router = Backbone.Router.extend
  routes:
    ...
    'account': 'account'
  index: ->
    React.render `<MainPage postsCollection = { mainPagePostsCollection } />`, reactWrapper

  account: ->
    React.render `<UserAccount userPostsCollection = { userPostsCollection } />`, reactWrapper
