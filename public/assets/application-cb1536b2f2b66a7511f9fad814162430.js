  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("div", null, "Title: ", this.props.title), 
        React.createElement("div", null, "Body: ", this.props.body), 
        React.createElement("div", null, "Created: ", this.props.created_at), 
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "postBox"}, 
        ...
        React.createElement(Posts, {data: this.props.posts})
      )
    );
  }
});
    ...
    return (
      React.createElement("div", null, 
        React.createElement("div", {className: "commentForm"}, 
          React.createElement("h3", null, "Submit new post"), 
          React.createElement("input", {type: "text", className: "form-control", placeholder: "Title", ref: "title"}), 
          React.createElement("br", null), 
          React.createElement("textarea", {className: "form-control", placeholder: "Subject", ref: "body"})
        )
      )
    );
  }
    ...
    var PostNodes = this.props.data.map(function (post) {
      return (
        React.createElement("div", null, 
          ...
          React.createElement("li", {key: post.key}, 
            React.createElement(Post, {title: post.title, body: post.body})
          )
          )
        )
      );
